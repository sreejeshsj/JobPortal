  ...
  return (
    <div className='absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      <form className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        {
            state === 'Login' ?<p >Don't have an account <span className='text-sm text-blue-600 cursor-pointer' onClick={()=>setState('Sign Up')}>Sign Up</span></p> : <p >Already have an account <span className='text-sm text-blue-600 cursor-pointer' onClick={()=>setState('Login')}>Login</span></p>
        }
